...
public class MultiAnswerTests extends TestCase {
    ...
    public void testGetCorrectAnswersMultiple() {
        ...
        MultiAnswer q = new MultiAnswer(1, "MultipleAnswer", "Test question", false, createAnswerList(data));
    ...
    public void testSortedAllCorrect() {
        ...
        MultiAnswer q = new MultiAnswer(1, "MultipleAnswer", "Name 3 countries", true, createAnswerList(data));
    ...
    public void testSortedSomeIncorrect() {
        ...
        MultiAnswer q = new MultiAnswer(2, "MultipleAnswer", "Give three letters", true, createAnswerList(data));
    ...
    public void testSortedTooFewAnswers() {
        ...
        MultiAnswer q = new MultiAnswer(4, "MultipleAnswer", "Three letters", true, createAnswerList(data));
    ...
    public void testUnsortedAllCorrect() {
        ...
        MultiAnswer q = new MultiAnswer(5, "MultipleAnswer", "Fruits", false, createAnswerList(data));
    ...
    public void testUnsortedDuplicatesInAnswers() {
        ...
        MultiAnswer q = new MultiAnswer(6, "MultipleAnswer", "Fruits", false, createAnswerList(data));
    ...
    public void testUnsortedMoreAnswersThanCorrect() {
        ...
        MultiAnswer q = new MultiAnswer(7, "MultipleAnswer", "Two letters", false, createAnswerList(data));
    ...
    public void testUnsortedAnswerWithExtraWhitespace() {
        ...
        MultiAnswer q = new MultiAnswer(8, "MultipleAnswer", "Greetings", false, createAnswerList(data));
    ...
    public void testUnsortedWithSynonyms() {
        ...
        MultiAnswer q = new MultiAnswer(9, "MultipleAnswer", "Name 3 countries", false, createAnswerList(data));
    ...
    public void testConstructorRejectsNullList() {
        try {
            new MultiAnswer(10, "MultipleAnswer", "Invalid", false, null);
    ...
    public void testConstructorRejectsEmptyList() {
        try {
            new MultiAnswer(11, "MultipleAnswer", "Invalid", false, new ArrayList<>());
            fail("Expected IllegalArgumentException");
        } catch (IllegalArgumentException e) {
            // Pass
        }
    ...
    public void testUnsupportedGetScore() {
        MultiAnswer q = new MultiAnswer(12, "MultipleAnswer", "Unsupported", false, createAnswerList(new String[][]{{"a"}}));
        try {
            q.getScore("a");
    ...
    public void testUnsupportedGetCorrectAnswers() {
        MultiAnswer q = new MultiAnswer(13, "MultipleAnswer", "Unsupported", false, createAnswerList(new String[][]{{"a"}}));
        try {
            q.getCorrectAnswers();
            fail("Expected UnsupportedOperationException");
        } catch (UnsupportedOperationException e) {
    ...
    public void testSortedExactMatch() {
        ...
        MultiAnswer q = new MultiAnswer(1, "MultipleAnswer", "Numbers", true, createAnswerList(data));
    ...
    public void testSortedWrongOrder() {
        String[][] data = { {"one"}, {"two"}, {"three"} };
        MultiAnswer q = new MultiAnswer(2, "MultipleAnswer", "Numbers", true, createAnswerList(data));
    ...
    public void testUnsortedAnyOrder() {
        String[][] data = { {"one"}, {"two"}, {"three"} };
        MultiAnswer q = new MultiAnswer(3, "MultipleAnswer", "Numbers", false, createAnswerList(data));
        List<String> answers = List.of("three", "two", "one");
        assertEquals(3, q.getScoreMultiple(answers));
    }
    ...
    public void testUnsortedDuplicateUserAnswers() {
        String[][] data = { {"one"}, {"two"}, {"three"} };
        MultiAnswer q = new MultiAnswer(4, "MultipleAnswer", "Numbers", false, createAnswerList(data));
    ...
    public void testSynonymsInSingleSlot() {
        ...
        MultiAnswer q = new MultiAnswer(5, "MultipleAnswer", "Countries", false, createAnswerList(data));
    ...
    public void testEmptyUserAnswers() {
        String[][] data = { {"a"} };
        MultiAnswer q = new MultiAnswer(6, "MultipleAnswer", "Single letter", true, createAnswerList(data));
    ...
    public void testNullUserAnswers() {
        String[][] data = { {"a"} };
        MultiAnswer q = new MultiAnswer(7, "MultipleAnswer", "Single letter", true, createAnswerList(data));
        try {
    ...
    public void testUserAnswersTooMany() {
        String[][] data = { {"a"}, {"b"} };
        MultiAnswer q = new MultiAnswer(8, "MultipleAnswer", "Two letters", true, createAnswerList(data));
    ...
    public void testUnsupportedGetScoreSingle() {
        String[][] data = { {"a"} };
        MultiAnswer q = new MultiAnswer(9, "MultipleAnswer", "Single letter", true, createAnswerList(data));
        try {
            q.getScore("a");
            fail("Expected UnsupportedOperationException");
        } catch (UnsupportedOperationException e) {
    ...
    public void testWhitespaceAndCaseInsensitivity() {
        String[][] data = { {"hello"} };
        MultiAnswer q = new MultiAnswer(11, "MultipleAnswer", "Greeting", true, createAnswerList(data));
    ...
    public void testPartialCorrectAnswersUnsorted() {
        ...
        MultiAnswer q = new MultiAnswer(12, "MultipleAnswer", "Colors", false, createAnswerList(data));
